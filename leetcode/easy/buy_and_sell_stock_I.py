...
class Solution:
    ...
    def max_profit(prices: List[int]) -> int:
        ...
        min_price = float('inf')  # Отслеживаем минимальную цену (долину)
        max_profit = 0  # Отслеживаем максимальную прибыль
        ...
        for price in prices:
            ...
            if price < min_price:
                ...
                # Рассчитываем прибыль, если продадим по текущей цене
